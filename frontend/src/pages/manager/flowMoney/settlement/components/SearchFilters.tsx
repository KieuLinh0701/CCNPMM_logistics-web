        ...
        <Col span={24}>
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            <Input
              ...
              placeholder="Tìm theo mã đối soát, tên người nộp, tên người xác nhận, mã đơn hàng, nội dung ghi chú"
              value={searchText}
            ...
            >
              ...
              {statuses.map((t) => <Select.Option key={t} value={t}>{translatePaymentSubmissionStatus(t)}</Select.Option>)}
            </Select>
